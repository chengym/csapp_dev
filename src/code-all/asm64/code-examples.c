...
void overwrite(int a0, int a1, int a2, int a3, int a4, int a5, int a6)
{
...
float inner_prodF(float x[], float y[], int n)
{
    int i;
    float result = 0.0;
    for (i = 0; i < n; i++) {
...
double inner_prodD(double x[], double y[], int n)
{
    int i;
    double result = 0.0;
    for (i = 0; i < n; i++) {
...
/* Index into array of 
   struct_ele's */
struct_ptr a_index(struct_ele a[], int idx)
{
    return &a[idx];
}
